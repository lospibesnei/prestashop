<?php /* Smarty version Smarty-3.1.14, created on 2015-11-08 16:46:22
         compiled from "C:\wamp\www\prestashop\themes\leoshoe\product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2281563ad823f3eb50-95584729%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '42747760d6e8d353bc7103531e2d2f963f2d8a50' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop\\themes\\leoshoe\\product-list.tpl',
      1 => 1446822915,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2281563ad823f3eb50-95584729',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_563ad824eea1c4_14350715',
  'variables' => 
  array (
    'products' => 0,
    'product' => 0,
...
<?php if ($_valid && !is_callable('content_563ad824eea1c4_14350715')) {function content_563ad824eea1c4_14350715($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
?>
		...
		<?php if (($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%3==0)||$_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>
			<div class="row">
		<?php }?>

		<div class="p-item col-md-4 col-sm-12 ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['last']){?>last_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?> clearfix">
			<div class="box">				
...
"<?php }?> />
					...
					<h3 class="s_title_block"><?php if (isset($_smarty_tpl->tpl_vars['product']->value['pack_quantity'])&&$_smarty_tpl->tpl_vars['product']->value['pack_quantity']){?><?php echo (intval($_smarty_tpl->tpl_vars['product']->value['pack_quantity'])).(' x ');?>
					...
					<?php if (($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']==0||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&$_smarty_tpl->tpl_vars['product']->value['minimal_quantity']<=1&&$_smarty_tpl->tpl_vars['product']->value['customizable']!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
						<?php if (($_smarty_tpl->tpl_vars['product']->value['allow_oosp']||$_smarty_tpl->tpl_vars['product']->value['quantity']>0)){?>
							<?php if (isset($_smarty_tpl->tpl_vars['static_token']->value)){?>
								<a class="button btn ajax_add_to_cart_button exclusive" rel="ajax_id_product_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
"><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
							...
							<?php }?>						
						<?php }else{ ?>
							<span class="exclusive btn"><?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
</span>
						<?php }?>
					<?php }?>

					<a class="button btn lnk_view" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['link'], 'htmlall', 'UTF-8');?>
...
"><?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
		...
		<!-- close row -->
		<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['products']['last']||$_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index']%3==2){?>
			</div>
		<?php }?>
