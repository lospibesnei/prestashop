<?php /* Smarty version Smarty-3.1.14, created on 2015-11-05 00:56:12
         compiled from "C:\wamp\www\prestashop\themes\leoshoe\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9629563ad35ce534d3-54817225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '422e0703e73222d62ae5099f0feb36fe37797915' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop\\themes\\leoshoe\\authentication.tpl',
      1 => 1446690703,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9629563ad35ce534d3-54817225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_563ad363659624_86622205',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_563ad363659624_86622205')) {function content_563ad363659624_86622205($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
.</p>
						...
						<div class="form-group text">
							<label class="col-sm-4 control-label" for="email_create"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
							<div class="col-sm-8">
...
" method="post" id="login_form" class="std form-horizontal clearfix">
				<div class="panel panel-default">
					...
					<div class="panel-body clearfix">
						<div class="form-group text">
							<label class="col-sm-4 control-label" for="email"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
							<div class="col-sm-8">
...
<?php }?>" class="account_input form-control" />
						...
						<div class="form-group text">
							<label class="col-sm-4 control-label" for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</label>
							<div class="col-sm-8"><input type="password" id="passwd" name="passwd" value="<?php if (isset($_POST['passwd'])){?><?php echo stripslashes($_POST['passwd']);?>
...
" />
						...
						<p class="lost_password pull-right"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('password'), ENT_QUOTES, 'UTF-8', true);?>
...
" method="post" id="new_account_form" class="std form-horizontal clearfix">
		<div class="panel panel-default">
			<h3 class="panel-heading"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h3>
...
<?php }?>" />
						...
						<div id="vat_number" style="display:none;">
							<div class="form-group text">
								<label class="col-sm-4 control-label" for="vat_number"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
</label>
								<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="form-group text">
							<label class="col-sm-4 control-label" for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
</label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="form-group required text">
							<label class="col-sm-4 control-label" for="address1"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="form-group required postcode text">
							<label class="col-sm-4 control-label" for="postcode"><?php echo smartyTranslate(array('s'=>'Zip / Postal Code'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" onblur="$('#postcode').val($('#postcode').val().toUpperCase());" />
						...
						<div class="form-group required text">
							<label class="col-sm-4 control-label" for="city"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="form-group required select">
							<label class="col-sm-4 control-label" for="id_country"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
						...
						<div class="form-group required id_state select">
							<label class="col-sm-4 control-label" for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?> <sup>*</sup><?php }?></label>
						<div class="col-sm-6">
							<input type="text" class="form-control text" name="phone_mobile_invoice" id="phone_mobile_invoice" value="<?php if (isset($_POST['phone_mobile_invoice'])){?><?php echo $_POST['phone_mobile_invoice'];?>
<?php }?>" />
						</div>
					</div>
...
?>
	...
	<?php }?>-->
<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" method="post" id="account-creation_form" class=" std form-horizontal clearfix">
...
&nbsp;&nbsp;</option>
	...
	<div class="panel panel-default account_creation">
		...
		<div class="panel-body">
			<div class="form-group text">
				<label class="col-sm-4 control-label" for=""><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</label>
				<div class="col-sm-6">
					<input type="text" class="form-control text" id="company" name="company" value="<?php if (isset($_POST['company'])){?><?php echo $_POST['company'];?>
<?php }?>" />
			...
			<div class="form-group text">
				<label class="col-sm-4 control-label" for="siret"><?php echo smartyTranslate(array('s'=>'SIRET'),$_smarty_tpl);?>
</label>
				<div class="col-sm-6">
...
<?php }?>" />
			...
			<div class="form-group text">
				<label class="col-sm-4 control-label" for="ape"><?php echo smartyTranslate(array('s'=>'APE'),$_smarty_tpl);?>
</label>
				<div class="col-sm-6">
...
<?php }?>" />
			...
			<div class="form-group text">
				<label class="col-sm-4 control-label" for="website"><?php echo smartyTranslate(array('s'=>'Website'),$_smarty_tpl);?>
</label>
				<div class="col-sm-6">
...
<?php }?>" />
				...
				<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="firstname"){?>
					<div class="form-group quired text">
						<label class="col-sm-4 control-label" for="firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6">
...
<?php }?>" />
				...
				<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="lastname"){?>
					<div class="form-group required text">
						<label class="col-sm-4 control-label" for="lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6">
...
<?php }?>" />
				...
				<?php }elseif($_smarty_tpl->tpl_vars['field_name']->value=="address2"){?>
					<div class="form-group text">
						<label class="col-sm-4 control-label" for="address2"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
</label>
						<div class="col-sm-6">
...
<?php }?>" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
 ...
 <sup>*</sup></label>
			...
			<?php }?>
			<div class="textarea">
				<label class="col-sm-4 control-label" for="other"><?php echo smartyTranslate(array('s'=>'Additional information'),$_smarty_tpl);?>
</label>
				<div class="col-sm-6">
...
<?php }?></textarea>
			...
			<?php }?>
			<div class="form-group text">
				<label class="col-sm-4 control-label" for="phone"><?php echo smartyTranslate(array('s'=>'Home phone'),$_smarty_tpl);?>
</label>
				<div class="col-sm-6">
...
<?php }?>" />
			...
			<div class="form-group <?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?>required <?php }?> text">
				<label class="col-sm-4 control-label" for="phone_mobile"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?> <sup>*</sup><?php }?></label>
				<div class="col-sm-6">
					<input type="text" class="form-control text" name="phone_mobile" id="phone_mobile" value="<?php if (isset($_POST['phone_mobile'])){?><?php echo $_POST['phone_mobile'];?>
<?php }?>" />
			...
			<div class="form-group required text" id="address_alias">
				<label class="col-sm-4 control-label" for="alias"><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-6">
...
<?php }?>" />
 ...
 <sup>*</sup></label>
				<div class="col-sm-6">
					<input type="text" class="form-control text" name="dni" id="dni" value="<?php if (isset($_POST['dni'])){?><?php echo $_POST['dni'];?>
<?php }?>" />
					<span class="help-block form_info"><?php echo smartyTranslate(array('s'=>'DNI / NIF / NIE'),$_smarty_tpl);?>
</span>
				</div>
			</div>
		</div>
