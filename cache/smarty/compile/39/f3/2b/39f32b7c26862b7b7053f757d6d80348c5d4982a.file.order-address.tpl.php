<?php /* Smarty version Smarty-3.1.14, created on 2015-11-05 01:00:17
         compiled from "C:\wamp\www\prestashop\themes\leoshoe\order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19123563ad4512e64e3-18189892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '39f32b7c26862b7b7053f757d6d80348c5d4982a' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop\\themes\\leoshoe\\order-address.tpl',
      1 => 1446690710,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19123563ad4512e64e3-18189892',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_563ad454867238_80387608',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_563ad454867238_80387608')) {function content_563ad454867238_80387608($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\function.counter.php';
...
<?php }?>
	<div class="addresses clearfix">
		<div  class="address_delivery select form-group clearfix">
			<label class="control-label col-sm-4" for="id_address_delivery"><?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?><?php echo smartyTranslate(array('s'=>'Choose a billing address:'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['address']->value['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['address']->value['alias'], 'htmlall', 'UTF-8');?>
		...
		<div class="form-group addressesAreEquals col-xs-12 clearfix" <?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?>style="display:none;"<?php }?>>
			<div class="checkbox ">
...
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button"><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
</a>
		</p>
		<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
		<div id="ordermsg" class="clearfix">
			...
			<label class="txt"><?php echo smartyTranslate(array('s'=>'If you would like to add a comment about your order, please write it in the field below.'),$_smarty_tpl);?>
				...
				<textarea class="form-control" rows="4" name="message"><?php if (isset($_smarty_tpl->tpl_vars['oldMessage']->value)){?><?php echo $_smarty_tpl->tpl_vars['oldMessage']->value;?>
<?php }?></textarea>
			</div>
		</div>
		<?php }?>
