<?php /* Smarty version Smarty-3.1.14, created on 2015-11-06 12:54:19
         compiled from "C:\wamp\www\prestashop\themes\leoshoe\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1870563ac15199cb91-18972222%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5496d3725d5427ca65e2b78f0a8c57b5c0a4e7e7' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop\\themes\\leoshoe\\modules\\blockcart\\blockcart.tpl',
      1 => 1446822913,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1870563ac15199cb91-18972222',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_563ac152f3acc2_48756944',
  'variables' => 
  array (
    'ajax_allowed' => 0,
...
<?php if ($_valid && !is_callable('content_563ac152f3acc2_48756944')) {function content_563ac152f3acc2_48756944($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
...
" rel="nofollow"> </a></div>
	...
	<?php }?>
		...
		<table class="table-responsive" id="vouchers"<?php if (count($_smarty_tpl->tpl_vars['discounts']->value)==0){?> style="display:none;"<?php }?>>
			<tbody>
...
<?php }?></span>
		...
		<p id="cart-buttons">
			...
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
" class="button_small btn" title="<?php echo smartyTranslate(array('s'=>'View my shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
" rel="nofollow">
			...
			<?php }?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
" id="button_order_cart" class="button exclusive<?php if ($_smarty_tpl->tpl_vars['order_process']->value=='order-opc'){?>_large<?php }?>" title="<?php echo smartyTranslate(array('s'=>'Check out','mod'=>'blockcart'),$_smarty_tpl);?>
