...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3016563ad2af977748-17753636',
  'function' => 
  array (
  ),
  'variables' => 
...
<?php }?>" method="post" id="voucher" class="form-inline">
						<fieldset>
...
<?php }?>" class="button pull-right standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
 &raquo;</a>
		<?php if (Configuration::get('PS_ALLOW_MULTISHIPPING')){?>
			<a href="<?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&amp;back={$back}');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1');?>
<?php }?>&amp;multi-shipping=1" class="multishipping-button pull-right multishipping-checkout button" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
 &raquo;</a>
		<?php }?>
	<?php }?>
...
<?php }?>" class="button" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
