<?php /* Smarty version Smarty-3.1.14, created on 2015-11-05 01:01:11
         compiled from "C:\wamp\www\prestashop\themes\leoshoe\order-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2160563ad4873d06b3-82099990%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cf5a6cec37cdac06de1ae1a772b51133855cbbb' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop\\themes\\leoshoe\\order-carrier.tpl',
      1 => 1446690710,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2160563ad4873d06b3-82099990',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_563ad4893fb243_20957375',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_563ad4893fb243_20957375')) {function content_563ad4893fb243_20957375($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
	...
	<form class="form-horizontal" id="form" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"multi-shipping=".((string)$_smarty_tpl->tpl_vars['multi_shipping']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
?>
				<div class="delivery_option <?php if (($_smarty_tpl->tpl_vars['option']->index%2)){?>alternate_<?php }?>item form-group">
					<input class="delivery_option_radio col-sm-1" type="radio" name="delivery_option[<?php echo $_smarty_tpl->tpl_vars['id_address']->value;?>
...
" <?php if (isset($_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value])&&$_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value]==$_smarty_tpl->tpl_vars['key']->value){?>checked="checked"<?php }?> />
					...
					<label class="col-sm-11" for="delivery_option_<?php echo $_smarty_tpl->tpl_vars['id_address']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['option']->index;?>
">
						<table class="resume col-sm-12 table-responsive">
							<tr>
...
?>
 ...
 <?php echo smartyTranslate(array('s'=>'(tax incl.)'),$_smarty_tpl);?>
						...
						<table class=" table-responsive col-sm-12 delivery_option_carrier <?php if (isset($_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value])&&$_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value]==$_smarty_tpl->tpl_vars['key']->value){?>selected<?php }?> <?php if ($_smarty_tpl->tpl_vars['option']->value['unique_carrier']){?>not-displayable<?php }?>">
							<?php  $_smarty_tpl->tpl_vars['carrier'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['carrier']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['option']->value['carrier_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['carrier']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['carrier']->iteration=0;
...
<?php }?><?php }?>)
		...
		<p id="gift_div" class="textarea">
			...
			<textarea rows="5" cols="35" id="gift_message" name="gift_message" class="form-control"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cart']->value->gift_message, 'htmlall', 'UTF-8');?>
</textarea>
		</p>
		<?php }?>
	<?php }?>
...
<?php }else{ ?>
	...
	<div>
		...
		<p><textarea class="form-control" cols="120" rows="3" name="message" id="message"><?php if (isset($_smarty_tpl->tpl_vars['oldMessage']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['oldMessage']->value, 'htmlall', 'UTF-8');?>
<?php }?></textarea></p>
	</div>
</div>
<?php }?>
