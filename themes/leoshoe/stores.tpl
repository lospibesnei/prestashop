...
{else}
	...
	<div class="form-horizontal">
		<div class="form-group">
			<label for="addressInput" class="col-sm-3 control-label">{l s='Your location:'}</label>
			<div class="col-sm-9">
		...
		<div class="form-group">
			<label for="radiusSelect" class="col-sm-3 control-label">{l s='Radius:'}</label> 
			<div class="col-sm-9">
    ...
    <div id="map"></div>
	<table cellpadding="0" cellspacing="0" border="0" id="stores-table" class="table-bordered table_block table-responsive">
		<tr>
			<th>{l s='#'}</th>
			<th>{l s='Store'}</th>
			<th>{l s='Address'}</th>
