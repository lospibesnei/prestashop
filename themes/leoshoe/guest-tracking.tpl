...
{if isset($order_collection)}
	...
	{else}
		<form method="post" action="{$action|escape:'htmlall':'UTF-8'}#guestToCustomer" class="std form-horizontal">
			<fieldset class="description_box">
				...
				<div class="form-group text">
					<label class="col-sm-4 control-label">{l s='Set your password:'}</label>
					<div class="col-sm-8">
				...
				<p class="center"><input type="submit" class="button" name="submitTransformGuestToCustomer" value="{l s='Send'}" /></p>
			</fieldset>
		</form>
	{/if}
{else}
	...
	{/if}
	<form method="post" action="{$action|escape:'htmlall':'UTF-8'}" class="std form-horizontal">
		<fieldset class="description_box">
			<p>{l s='To track your order, please enter the following information:'}</p>
			<div class="form-group">
				<label class="col-sm-4 control-label">{l s='Order Reference:'} </label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label">{l s='Email'}</label>
				<div class="col-sm-8">
