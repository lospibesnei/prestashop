...
<form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std form-horizontal" id="form_forgotpassword">
	<fieldset>
		...
		<div class="text form-group">
			<div class="submit col-sm-offset-4 col-sm-6">
...
<div class="clear footer_links">
	<a href="{$link->getPageLink('authentication')|escape:'html'}" title="{l s='Back to Login'}" rel="nofollow"><span class="fa fa-user"></span>{l s='Back to Login'}</a>
</div>
