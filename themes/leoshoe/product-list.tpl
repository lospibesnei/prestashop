...
{if isset($products)}
	...
	{foreach from=$products item=product name=products}
		...
		{if ($smarty.foreach.products.index % 3 == 0) || $smarty.foreach.products.first}
			<div class="row">
		{/if}
		...
		<div class="p-item col-md-4 col-sm-12 ajax_block_product {if $smarty.foreach.products.first}first_item{elseif $smarty.foreach.products.last}last_item{/if} {if $smarty.foreach.products.index % 2}alternate_item{else}item{/if} clearfix">
			...
			<div class="product-container">				
				<div class="center_block">
					...
					<div class="content_price">
						...
						<span class="availability">
							{if ($product.allow_oosp || $product.quantity > 0)}{l s='Available'}{elseif (isset($product.quantity_all_versions) && $product.quantity_all_versions > 0)}
				...
				<div class="right_block">						
					...
					<a class="button btn lnk_view" href="{$product.link|escape:'htmlall':'UTF-8'}" title="{l s='View'}">{l s='View'}</a>
				</div>
			</div>
			</div>
		</div>
		...
		<!-- close row -->
		{if $smarty.foreach.products.last || $smarty.foreach.products.index % 3 == 2}
			</div>
		{/if}
