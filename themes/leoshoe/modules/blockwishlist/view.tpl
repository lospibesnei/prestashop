...
<div class="wlp_bought">
    <div class="clearfix wlp_bought_list row">
        {foreach from=$products item=product name=i}
            <div id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="col-md-4 col-sm-3 address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
                <div class="product-container">
                    <div class="image">
                        <a class="product_image" href="{$link->getProductlink($product.id_product, $product.link_rewrite, $product.category_rewrite)|escape:'html'}" title="{l s='Product detail' mod='blockwishlist'}">
                    ...
                    <div class="product_infos product-meta">
                        <h3 class="product_name">{$product.name|truncate:30:'...'|escape:'htmlall':'UTF-8'}</h3>
