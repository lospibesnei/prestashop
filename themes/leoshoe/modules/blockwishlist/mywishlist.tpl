...
<div id="mywishlist">
	...
	<ul class="footer_links">
		<li>
			<a class="btn" href="{$link->getPageLink('my-account', true)|escape:'html'}">{l s='Back to Your Account' mod='blockwishlist'}</a>
		</li>
		<li class="f_right">
			<a class="btn" href="{$base_dir}">{l s='Home' mod='blockwishlist'}</a></li>
	</ul>
</div>
