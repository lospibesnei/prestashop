...
<div id="cart_block" class="block exclusive">
	...
	{/if}
		...
		<table class="table-responsive" id="vouchers"{if $discounts|@count == 0} style="display:none;"{/if}>
			<tbody>
		...
		<p id="cart-buttons">
			...
			<a href="{$link->getPageLink("$order_process", true)|escape:'html'}" class="button_small btn" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
				{l s='Cart' mod='blockcart'}
			</a>
			{/if}
			<a href="{$link->getPageLink("$order_process", true)|escape:'html'}" id="button_order_cart" class="button exclusive{if $order_process == 'order-opc'}_large{/if}" title="{l s='Check out' mod='blockcart'}" rel="nofollow"><span></span>{l s='Check out' mod='blockcart'}</a>
		</p>
	</div>
	</div>
</div>
