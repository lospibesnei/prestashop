...
<form action="{$link->getModuleLink('bankwire', 'validation', [], true)|escape:'html'}" method="post" class="box">
<p>
...
<p class="cart_navigation" id="cart_navigation">
	...
	<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="button_large btn">{l s='Other payment methods' mod='bankwire'}</a>
</p>
</form>
{/if}
