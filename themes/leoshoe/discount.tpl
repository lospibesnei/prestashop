...
<table class="discount std table table-bordered table-responsive">
	<thead>
		<tr>
...
<ul class="footer_links clearfix">
	<li class="f_left"><a class="btn" href="{$link->getPageLink('my-account', true)|escape:'html'}"> {l s='Back to your account'}</a></li>
